...
import 'package:tapmetapyou/Screens/Tab.dart';
import 'package:tapmetapyou/Screens/Welcome.dart';
import 'package:tapmetapyou/Screens/auth/otp.dart';
import 'package:tapmetapyou/models/custom_web_view.dart';
import 'package:tapmetapyou/util/color.dart';
import 'package:url_launcher/url_launcher.dart';

class Login extends StatelessWidget {
  static const your_client_id = '1070548086768546';
  final FirebaseAuth _auth = FirebaseAuth.instance;
  static const your_redirect_url =
      'https://tapmetapyou2021.firebaseapp.com/__/auth/handler';
                        ...
                        child: i.AppleSignInButton(
                          ...
                          onPressed: () async {
                            final FirebaseUser currentUser =
                              ...
                              // _scaffoldKey.currentState.showSnackBar(snackBar); old code
              ...
              Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () => _launchURL(
                        "https://www.deligence.com/apps/tapmetapyou/Privacy-Policy.html"), //TODO: add privacy policy
                  ),
                  Container(
                  ...
                  GestureDetector(
                    ...
                    onTap: () => _launchURL(
                        "https://www.deligence.com/apps/tapmetapyou/Terms-Service.html"), //TODO: add Terms and conditions
                  ),
                ],
              )
            ],
